...
import dribbblePicture from '../../assets/dribbble.png';
...
function Footer() {
  return (
    <footer className="footer--container">
      ...
      {/* Jovita Chong + email + socials */}
      <div className="footer--title--container">
        <div className="footer-title">Jovita Chong</div>
        <div styclassName="footer--content"><a href="mailto:jovitaachong@gmail.com">jovitaachong@gmail</a></div>
        ...
        <ul className="socials-container-links">
          ...
          <li>
            <a href="https://dribbble.com/jovitachong" target="_blank" title="Check out my designs on Dribbble" rel="noopener noreferrer">
              <img src={dribbblePicture} alt="Jovita Chong's Dribbble Profile" className="icon" />
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/jovita.ux/" target="_blank" title="Follow me on Instagram" rel="noopener noreferrer">
              <img src={instagramPicture} alt="Jovita Chong's Instagram Profile" className="icon" />
            </a>
          </li>
        </ul>
      ...
      <div className="footer--link--container">
        {/* <div className="footer--social--icon">
          <p className="footer--content" style={{ margin: "1rem" }}>Let's connect</p>
        </div> */}

      </div>
        {/* <p className="footer--content">Copyright © 2023. All Rights Reserved.</p> */}
        {/* <p className="footer--content">Copyright © 2023 Made and designed by Jovita Chong.</p>
        <p className="footer--content">All Rights Reserved.</p> */}
